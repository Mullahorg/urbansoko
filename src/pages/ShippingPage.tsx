...
import { Truck, Package, Clock, MapPin, Rocket, Zap } from 'lucide-react';
              ...
              <Card className="p-6 card-cyber">
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold mb-1">Major Cities</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground mb-4">
                      Once your order ships, you'll receive a tracking code via email and SMS.
                    </p>
                    <a href="/track-order" className="text-primary hover:underline font-medium">
                      Track Order →
                    </a>
                  </div>
                </div>
