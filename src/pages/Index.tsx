...
const iconMap: Record<string, React.ComponentType<any>> = {
  Truck, Shield, Headphones, Package, Award, Clock, Star, Store, Cpu, Rocket, Globe, Scan, Bot
};
...
const Index = () => {
  ...
  const futuristicFeatures = [
    { icon: Cpu, title: 'AI-Powered', description: 'Smart recommendations tailored to your style' },
    { icon: Rocket, title: 'Express Delivery', description: 'Same-day delivery across Nairobi' },
    { icon: Shield, title: 'Secure Payments', description: 'M-Pesa & card payments protected' },
  ];
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              ...
              <motion.span 
                className="block text-gradient-cyber mt-2"
            ...
            >
              <Button 
                size="lg" 
                className="w-full sm:w-auto text-base md:text-lg px-10 py-7 btn-cyber font-semibold group" 
                asChild
              >
                <Link to="/stores">
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="w-full sm:w-auto text-base md:text-lg px-10 py-7 group border-primary/30 hover:border-primary hover:bg-primary/5" 
                asChild
              >
                <Link to="/products">
              ...
              <motion.div key={index} variants={itemVariants}>
                <Card className="card-cyber text-center border-none group cursor-pointer h-full">
                  <CardContent className="pt-10 pb-8 px-8">
                    <motion.div 
                      className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-primary/20 via-primary/10 to-transparent mb-6 group-hover:neon-glow transition-all"
        ...
        <div className="container mx-auto px-4">
          ...
          >
            {loading ? (
              ...
              <div className="col-span-full text-center py-16 text-muted-foreground">No featured products available</div>
            ) : (
      ...
      <section className="py-16 relative overflow-hidden">
        ...
        <motion.div
          ...
          animate={{ x: [0, 60], y: [0, 30] }}
          transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
        />
        
        <div className="container mx-auto px-4 relative z-10">
          <motion.div 
            className="flex flex-col md:flex-row items-center justify-between gap-8 text-primary-foreground"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          >
        ...
        <div className="container mx-auto px-4">
          ...
          >
            {loading ? (
              ...
              <div className="col-span-full text-center py-12 text-muted-foreground">No new arrivals available</div>
            ) : (
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          >
            {[
              { name: "Sarah M.", location: "Nairobi", text: "UrbanSoko has completely changed how I shop online. The AI recommendations are spot on!" },
              { name: "James K.", location: "Mombasa", text: "Fast delivery and amazing product quality. M-Pesa checkout makes everything seamless." },
              { name: "Grace W.", location: "Kisumu", text: "Love the variety of products and the futuristic shopping experience. 5 stars!" }
